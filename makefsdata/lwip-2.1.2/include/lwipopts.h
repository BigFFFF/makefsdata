...
/* USER CODE BEGIN 1 */
#define LWIP_DEBUG  1
#define MEMP_NUM_PARALLEL_HTTPD_CONNS       5  // 同时支持多少个 HTTP 连接
#define MEMP_NUM_PARALLEL_HTTPD_SSI_CONNS   3  // 如果开启了 SSI，也要设置
...
/*----- Default Value for LWIP_HTTPD_OMIT_HEADER_FOR_EXTENSIONLESS_URI: 0 ---*/
#define LWIP_HTTPD_OMIT_HEADER_FOR_EXTENSIONLESS_URI 1
/* USER CODE END 1 */
